...
### 1. Prompt chaining
This technique involves breaking a complex task into sequential sub-steps. The output of step 1 becomes the input for step 2.
...
Instead of explaining everything from scratch (zero-shot), we provide the AI with a few examples (shots) of what is expected.
