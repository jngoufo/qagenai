...
Cette technique consiste à diviser une tâche complexe en sous-étapes séquentielles. La sortie de l'étape 1 devient l'entrée de l'étape 2.
...
Au lieu de tout expliquer (zero-shot), on donne à l'IA quelques exemples (shots) de ce qu'on attend.
