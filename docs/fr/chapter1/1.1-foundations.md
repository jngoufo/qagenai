...
## 1.1.2 Fonctionnement des LLM : tokenisation et contexte

Les moteurs de cette IA générative textuelle sont appelés **LLM (Large Language Models)** et reposent sur une architecture de réseau de neurones nommée **Transformer**. Pour bien cerner les LLM, nous devons comprendre deux mécanismes fondamentaux.
...
L'évolution ultime actuelle réside dans les **LLM multimodaux**. L'IA ne se cantonne plus au texte ; elle peut traiter simultanément images, audio et vidéo.
...
!!! info "🎓 Point syllabus (résumé K1/K2)"
    ...
    *   **Hallucination :** Fait de générer une information plausible mais factuellement fausse.
